...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TiktokGame2Server.Entities.BagItem", b =>
                {
                    ...
                    b.Property<string>("ItemBusinessId")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("TiktokGame2Server.Entities.Building", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("PlayerId", "BusinessId")
                        .IsUnique();

                    b.ToTable("Buildings");
                });

            modelBuilder.Entity("TiktokGame2Server.Entities.BuildingUpgradSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTime>("UpgradeBeginAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime>("UpgradeEndAt")
                        .HasColumnType("timestamp with time zone");

                    b.HasKey("Id");

                    b.HasIndex("PlayerId", "BuildingId")
                        .IsUnique();

                    b.ToTable("BuildingUpgradSchedules");
                });

            modelBuilder.Entity("TiktokGame2Server.Entities.Currency", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TiktokGame2Server.Entities.Formation", b =>
                {
                    ...
                    b.Property<string>("FormationBusinessId")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("PlayerId", "FormationType")
                        .IsUnique();

                    b.ToTable("Formations");
                });

            modelBuilder.Entity("TiktokGame2Server.Entities.FormationDeploy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("FormationType", "SamuraiId", "PlayerId")
                        .IsUnique();

                    b.ToTable("FormationDeploy");
                });

            modelBuilder.Entity("TiktokGame2Server.Entities.GuideProgress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("GuideBusinessId")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("TiktokGame2Server.Entities.Samurai", b =>
                {
                    ...
                    b.Property<string>("SoldierBusinessId")
                        .IsRequired()
                        .HasColumnType("text");
